        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddedByEmployeeId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderItems_Employees_AddedByEmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_AddedByEmployeeId",
                table: "OrderItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_RoomId_BookingDate_TimeSlot",
                table: "Orders",
                columns: new[] { "RoomId", "BookingDate", "TimeSlot" });
